 ...
 *
 */
public class CX002Action  extends BaseAction {
	...
	private static final transient Logger log = Logger
			.getLogger(CX002Action.class);

	/** 默认的构造函数 */
	public CX002Action() {
		log.info("CX002Action constructed");
	}
...
//		//获取服务配置JSON
	...
	public String saveConfigInfo() throws Exception {
		log.info("CX002Action saveConfigInfo");
