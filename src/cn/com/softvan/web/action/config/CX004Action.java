 ...
 *
 */
public class CX004Action  extends BaseAction {
	...
	private static final transient Logger log = Logger
			.getLogger(CX004Action.class);

	/** 默认的构造函数 */
	public CX004Action() {
		log.info("CX004Action constructed");
	}
	 ...
	 * </p>
	 * <ol>
	 * [功能概要] <div>显示 修改服务结果。</div>
	 * </ol>
	 * 
	 * @return 转发字符串
	 */
	public String configInfo() throws Exception {
		log.info("CX004Action configInfo");
		//存放数据修改服务配置信息 BEAN CLASS
		...
		/****************************************************************************************************/
		//获取sql
		request.setAttribute("sql", serviceConfigManager.getSQl("U",dbConfigBean));
//		//获取服务配置JSON
		String jsonConfg=serviceConfigManager.getJsonConfig("U",dbConfigBean);
		
		request.setAttribute("jsonConfg",jsonConfg);
		//获取服务参数JSON
		String jsonInput=serviceConfigManager.getJsonInput("U",dbConfigBean);
		
		request.setAttribute("jsonInput",jsonInput);
		//获取服务返回信息JSON
		String jsonOutput=serviceConfigManager.getJsonOutput("U",dbConfigBean);
	...
	public String saveConfigInfo() throws Exception {
		log.info("CX004Action saveConfigInfo");
