...
<form action="${basePath}/cx/cx_config_i_list1.action" name="table_db_form" id="table_db_form" method="post" >
...
<table class="tablexx" width="100%" frame="box">
	...
	<tr>
		<td colspan="6" style="text-align: center;">
			<input type="button" onclick="if(checkInfo('dbs','radio')){submitFrom2('div_table_list','table_db_form',null);}else{myAlert('请选择你要操作的数据库!');}" class="btn" value="NEXT" />
		</td>
	</tr>
</table>
</form>
