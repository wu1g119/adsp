...
<form action="${basePath}/cx/cx_config_q_list2.action" name="table_list1_form" id="table_list1_form" method="post" >
	...
	<table class="tablexx" width="100%" frame="box">
		...
		<tr>
			<td colspan="10" style="text-align: center;">
				<input type="button" onclick="if(checkInfo('tableName','checkbox')){submitFrom2('div_table_columns_list','table_list1_form',null);}else{myAlert('请选择你要操作的数据库表!');}" class="btn" value="NEXT" />
			</td>
		</tr>
	</table>
</form>
