...
<script type="text/javascript" src="${basePath}/js/config/CX002_04.js"></script>

<form action="${basePath}/cx/cx_config_q_saveConfigInfo.action" name="table_configInfo_form" id="table_configInfo_form" method="post" >
<table class="tablexx" width="100%" frame="box">
	...
	<tr>
		<td>
			<input type="button" class="btn" onclick="submitFrom2('test_sql_div','table_configInfo_form','${basePath}/cx/cx_config_q_testSql.action');" value="TEST SQL" />
		</td>
	</tr>
	<tr>
		<td valign="top" id="test_sql_div_td">
			<!-- sql test 结果 -->
			<div id="test_sql_div" style="width: 1000px;overflow: scroll;" align="center"></div>
		</td>
	</tr>
	<!-- xxxxxxx生成配置信息xxxxxxxxxxxxxxxxxxxx -->
	<tr>
		<th>
			<font color="blue">生成配置信息,<a href="javascript:void(0);" onclick="copy_clip($('#Canvas').text());">COPY</a>
			</font>${error_msg}
		</th>
	</tr>
	<tr>
		<td valign="top" id="Canvas_div">
					...
					<div id="Canvas" class="Canvas" style="width: 1000px;overflow: scroll;"></div>
	...
	<tr>
		<th>
			<font color="blue">服务调用参数实例,<a href="javascript:void(0);" onclick="copy_clip($('#Canvas2').text());">COPY</a></font>${error_msg_input}
		</th>
	</tr>
	<tr>
		<td id="Canvas2_div">
			<textarea id="RawJson2" class="chackTextarea-area hide" name="jsonInput">${jsonInput}</textarea>
			<div id="Canvas2" class="Canvas" style="width: 1000px;overflow: scroll;"></div>
	...
	<tr>
		<th>
			<font color="blue">服务返回数据实例,<a href="javascript:void(0);" onclick="copy_clip($('#Canvas3').text());">COPY</a></font>${error_msg_output}
		</th>
	</tr>
	<tr>
		<td id="Canvas3_div">
			<textarea id="RawJson3" class="chackTextarea-area hide"  name="jsonOutput">${jsonOutput}</textarea>
			<div id="Canvas3" class="Canvas" style="width: 1000px;overflow: scroll;"></div>
...
<table class="tablexx" width="100%" frame="box">
	<tr>
		<td>
			<font color="blue">7.填写提取服务基本信息</font>
		</td>
	</tr>
	<tr>
		<th width="20%">
	...
	<tr>
		...
		<td>
			<input type="hidden" class="textw2012 w70" name="bean.type" value="Q" />Q查询
		</td>
	</tr>
	<tr>
		<th width="20%">
	...
	<tr>
		<td colspan="2" style="text-align: center;">
			<input type="button" onclick="initValidateSt00104();if(st00104Validator.form()){this.disabled=true;this.className='btn1';saveConfigInfo('${basePath}/cx/cx_config_q_saveConfigInfo.action');this.disabled=false;this.className='btn';}" class="btn" value="保存" />
		</td>
	</tr>
</table>
</form>
<script type="text/javascript">
	$('#test_sql_div').width($('#test_sql_div_td').width());
