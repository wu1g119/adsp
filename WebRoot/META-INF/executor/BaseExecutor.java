...
//    //TODO wuxiaogang 20130613 分页对象cahce
//    if (ms.isUseCache()) { 
//	    if(parameter instanceof java.util.HashMap){
//	  	  HashMap m=(HashMap)parameter;
//	  	  PageInfo page = (PageInfo)m.get("pageinfo");
//	  	  if(page!=null){
//	  		    try {
//					//分页对象key
//					String page_key="page_"+(boundSql.getSql());
//					//获取cache localCache不能用 可能做了限制吧
//					Cache cache = ms.getCache();
//					//分页标记key
//					cache.putObject("flag_"+page_key,"1");
//					//分页对象
//					cache.putObject(page_key,page);
////	  			System.out.println("2=总数="+page.getRecordCount());
//				} catch (Exception e) {
////					e.printStackTrace();
//				}
//	  	  }
